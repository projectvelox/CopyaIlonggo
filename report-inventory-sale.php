...
<div class="table-responsive">
	<table class="table table-hover">
		...
		<?php
			...
			$result = mysqli_query($con,"SELECT FORMAT(qty, 0) AS qty_1, FORMAT(price, 0) AS price_1, inventory.* FROM inventory WHERE type='Inventory' AND type_1='Brand New' ORDER BY equipment_name ASC");
