<?php
	...
	$ses_sql = mysqli_query($con,"select * from accounts where id = '$user_id' ");

	$row = mysqli_fetch_array($ses_sql,MYSQLI_ASSOC);

	$username = $row['username'];
	$fullname = $row['firstname'] . " " . $row['lastname'];
	$profilename = $row['firstname'] . " " . $row['middlename'] . " " . $row['lastname'];
	$profilefirst = $row['firstname'];
	$profilemiddle = $row['middlename'];
	$profilelast = $row['lastname'];
	$profileid = $row['id'];
	$profileage = $row['age'];
	$profilesex = $row['sex'];
...
<body>
	...
	<div class="container" style="margin-top: 50px; margin-bottom: 20px;">
		<ol class="breadcrumb">
		  ...
		  <li class="breadcrumb-item"><a href="customer-support.php">Customer Support</a></li>
		  <li class="breadcrumb-item active"><span><?php echo $fullname; ?>'s Profile</span></li>
		</ol>
		<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
			<div class="user-profile-pic">
				<img src="img/uploads/<?php echo $fullname;?>.jpg" class="img-responsive" onerror="src='img/icons/not-available.jpg'" >
			</div>
			<div class="bordify data-profile-container" style="text-align: left; padding: 10px; border-radius: 0px; margin-top: 10px;">
				<h4>Account Details:</h4>
				<h4>Basic Details:</h4>
				<span><strong>First Name: </strong></span><span><?php echo $profilefirst; ?></span><br>
				<span><strong>Middle Name: </strong></span><span><?php echo $profilemiddle; ?></span><br>
				<span><strong>Last Name: </strong></span><span><?php echo $profilelast; ?></span><br><br>
				<span><strong>Sex: </strong></span><span><?php echo $profilesex; ?></span><br>
				<br>
				<h4>Contact Details:</h4>
				<span><strong>Contact Number: </strong></span><span><?php echo $profilecontact; ?></span>
		...
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
			...
			<?php 
				$results = mysqli_query($con,"SELECT * FROM servicerequest WHERE user_id = '$user_id' ORDER BY id DESC");
