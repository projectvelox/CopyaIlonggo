...
<body>
	...
	<div class="container" style="margin-top: 50px; margin-bottom: 20px;">
		<ol class="breadcrumb">
		  ...
		  <li class="breadcrumb-item active"><span>Items For Rent</span></li>
		</ol>
		...
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
			...
			<?php 
				$results = mysqli_query($con, "SELECT * FROM inventory WHERE type_1 = '2nd Hand' AND status='Active' AND qty!='0' ORDER BY equipment_name ASC");
				...
				foreach($results as $row){
					...
					echo '<td>'.$row['qty'].'</td>';
					echo '<td><a class="btn btn-primary btn-sm" href="item-profile-specific.php?id='.$row['id'].'">Check</a></td>';
					echo '</tr>';
				}
				echo '</table>';
				echo '</div>';
