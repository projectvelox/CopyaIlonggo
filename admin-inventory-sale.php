		...
		<div class="row">
			<ol class="breadcrumb">
			  <li class="breadcrumb-item"><a href="admin-dashboard.php">Dashboard</a></li>
			   ...
			   <li class="breadcrumb-item active"><span>For Sale</span></li>
			</ol>
			<div style="margin-left: 15px; margin-right: 15px;">
			<div class="row">
				<h3 class="col-xs-12 col-sm-12 col-md-4 col-lg-4">Equipments For Sale</h3> 
				<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
					<form method="POST" action="admin-inventory-sale.php">
			...
			<div class="table-responsive">
				<table class="table table-hover">
					<tr>
						<th>#</th>
						<th><a data-toggle="tooltip" data-placement="bottom" title="Order by Item" href="admin-inventory-sale.php?name=equipment_name ASC">Item</th>
						...
						<th><a data-toggle="tooltip" data-placement="bottom" title="Order by Quantity" href="admin-inventory-sale.php?name=qty DESC">Qty.</th>
						<th><a data-toggle="tooltip" data-placement="bottom" title="Order by Buying Price" href="admin-inventory-sale.php?name=price DESC">Price</th>
						<th><a data-toggle="tooltip" data-placement="bottom" title="Order by Status" href="admin-inventory-sale.php?name=status DESC">Status</th>
					</tr>
					<?php
						$i=0;
						$searched = '';
						...
						$result = mysqli_query($con,"SELECT FORMAT(qty, 0) AS qty_1, FORMAT(price, 0) AS price_1, inventory.* FROM inventory WHERE equipment_name LIKE '%".$searched."%' AND (type='Inventory' AND type_1='Brand New') ORDER BY ".mysqli_real_escape_string($con, $x)."");
