	...
	<div class="container" style="margin-top: 80px;">
		<div class="row">
			<ol class="breadcrumb">
			   ...
			   <li class="breadcrumb-item active"><span>Rental Logs</span></li>
			</ol>
			<div style="margin-left: 15px; margin-right: 15px;">
			<div class="row">
				<h3 class="col-xs-12 col-sm-12 col-md-4 col-lg-4">Completed Rental Transactions</h3> 
				<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
					<form method="POST" action="admin-rental-list.php">
			...
			<div class="table-responsive">
				<table class="table table-hover">
					...
					<?php
						...
						$result = mysqli_query($con,"SELECT COUNT(*) AS number_of_equipments,borrower_cart.* FROM borrower_cart WHERE name LIKE '%".$searched."%' AND status='Returned' GROUP BY name ORDER BY ".mysqli_real_escape_string($con, $x)."");
							while($row = mysqli_fetch_array($result))
							{
								$i++;
								echo "<tr>";
								echo "<td>" . $i . ".</td>";
								echo "<td><a href='admin-return-page.php?name=".$row['name']."'>" . $row['name'] . "</a></td>";
